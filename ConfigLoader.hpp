...
struct ConfigLoader {
    ...
    //norecoil    
    int NORECOIL_PITCH_REDUCTION = 10;
    int NORECOIL_YAW_REDUCTION = 10;

    //aimbot
    bool AIMBOT_ACTIVATED_BY_ATTACK = true;
    bool AIMBOT_ACTIVATED_BY_ADS = false;
    std::string AIMBOT_ACTIVATED_BY_BUTTON = "XK_E";
    std::string FEATURE_MAP_RADAR_BUTTON = "NONE";
    int AIMBOT_SMOOTH = 35;
    float AIMBOT_SPEED = 50;
    int AIMBOT_SMOOTH_EXTRA_BY_DISTANCE = 5000;
    float AIMBOT_FOV = 3.0000;
